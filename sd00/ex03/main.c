...
int main(int argc, char *argv[])
{
	...
	// Window [95, 80, 60, 100, 120] has average 91 with 4 readings ≥ 70 but one reading > 150, so not critical
	run_test(test3, 10, 3, "Test 3");
	...
	// Window [95, 100, 60, 65, 130] has average 90 but only 2 readings ≥ 70, so not critical
	run_test(test5, 5, 0, "Test 5");
	...
	// Window [89, 89, 90, 92, 70] has average 86 with 2 readings >= 70, so not critical
	// Window [89, 90, 92, 70, 70] has average 82.2 with 3 readings >= 70, so not critical (avg < 90)
	...
	// Window [150, 90, 91, 92, 93] has a value >= 150, so not critical
	...
	// Window [96, 97, 98, 99, 150] has a value ≥ 150, so not critical
	// Window [97, 98, 99, 150, 90] has a value ≥ 150, so not critical
	run_test(test10, 13, 6, "Test 10 - Alternating pattern");
